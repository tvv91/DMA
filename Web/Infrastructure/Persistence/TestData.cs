...
namespace Web.Infrastructure.Persistence
{
    public class TestData
    {
        ...
        private Release CreateRelease(
            ...
            IReadOnlyList<StorageModel> storages,
            IReadOnlyList<Adc> adcs,
            IReadOnlyList<Amplifier> amplifiers,
            IReadOnlyList<Cartridge> cartridges,
            IReadOnlyList<Player> players,
            IReadOnlyList<Wire> wires)
        {
            ...
            StorageModel? storage = _random.Next(4) == 0 ? null : storages[_random.Next(storages.Count)];
        ...
        public List<Album> GetAlbums()
        {
            ...
            var storages = Enumerable.Range(1, 24)
                .Select(i => new StorageModel { Name = $"Seed Storage {i:D2}" })
                .ToList();
